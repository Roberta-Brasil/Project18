...
class ClothingsTest < ApplicationSystemTestCase
  ...
  test "creating a Clothing" do
    ...
    fill_in "Availability", with: @clothing.availability
    fill_in "Brand", with: @clothing.brand
    fill_in "Gender", with: @clothing.gender
    fill_in "Location", with: @clothing.location
    fill_in "Model", with: @clothing.model
