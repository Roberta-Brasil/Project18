...
class BikesTest < ApplicationSystemTestCase
  ...
  test "creating a Bike" do
    ...
    fill_in "Availability", with: @bike.availability
    fill_in "Brand", with: @bike.brand
    fill_in "Colour", with: @bike.colour
    fill_in "Gender", with: @bike.gender
    fill_in "Image Url", with: @bike.image_url
    fill_in "Location", with: @bike.location
    fill_in "Model", with: @bike.model
    fill_in "Price", with: @bike.price
    fill_in "Size", with: @bike.size
    fill_in "Type", with: @bike.type
