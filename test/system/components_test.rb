...
class ComponentsTest < ApplicationSystemTestCase
  ...
  test "creating a Component" do
    ...
    fill_in "Availability", with: @component.availability
    fill_in "Brand", with: @component.brand
    fill_in "Location", with: @component.location
    fill_in "Model", with: @component.model
    fill_in "Name", with: @component.name
    fill_in "Price", with: @component.price
