...
class AccessoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post accessories_url, params: { accessory: { availability: @accessory.availability, brand: @accessory.brand, image_url: @accessory.image_url, location: @accessory.location, model: @accessory.model, name: @accessory.name, price: @accessory.price } }
    end
  ...
  test "should update accessory" do
    patch accessory_url(@accessory), params: { accessory: { availability: @accessory.availability, brand: @accessory.brand, image_url: @accessory.image_url, location: @accessory.location, model: @accessory.model, name: @accessory.name, price: @accessory.price } }
